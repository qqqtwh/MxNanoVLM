...
def cli_evaluate(args: Union[argparse.Namespace, None] = None,eval_logger=None) -> None:
...
def cli_evaluate_single(args: Union[argparse.Namespace, None] = None,eval_logger=None) -> None:
